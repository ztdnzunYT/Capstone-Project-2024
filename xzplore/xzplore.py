    ...
    def draw_toolbar():
        ...
        if Game_State != "Space":
            ...
            if Toolbar.tool_num == 3:
                hint1 = pygame.transform.smoothscale(pygame.image.load("xzplore/assets/desert_planet_assets/desert_sandtiles/desert_sandtile_1.png").convert_alpha(),(80,80))
                hint2 = pygame.transform.smoothscale(pygame.image.load("xzplore/assets/moss_planet_assets/moss_rocks/moss_rock_4.png").convert_alpha(),(120,120))
                hint3 = pygame.transform.smoothscale(pygame.image.load("xzplore/assets/desert_planet_assets/desert_crawler.png").convert_alpha(),(100,100))
                surface = pygame.Surface((300,400),pygame.SRCALPHA)
                pygame.draw.rect(surface,(0,0,0,100),(0,0,300,400),border_radius=5)
                pygame.draw.rect(surface,(0,0,0,255),(0,0,300,400),5,border_radius=5)
                screen.blit(surface,(SCREEN_WIDTH-320,SCREEN_HEIGHT-420))
                screen.blit(hint1,(SCREEN_WIDTH-300,SCREEN_HEIGHT/2))
                screen.blit(hint2,(SCREEN_WIDTH-320,SCREEN_HEIGHT/2+90))
                screen.blit(hint3,(SCREEN_WIDTH-310,SCREEN_HEIGHT/2+200))
                font = pygame.font.Font(None,25)
                text = font.render("Use shovel on disturbed dirt", True, (255, 255, 255))  # White color text
                text_rect = text.get_rect(center=(SCREEN_WIDTH-190, SCREEN_HEIGHT-300))
                text2 = font.render("Use pickaxe to mine rocks", True, (255, 255, 255))  # White color text
                text_rect2 = text.get_rect(center=(SCREEN_WIDTH-190,  SCREEN_HEIGHT-200))
                text3 = font.render("Use gun to kill enemys", True, (255, 255, 255))  # White color text
                text_rect3 = text.get_rect(center=(SCREEN_WIDTH-190,  SCREEN_HEIGHT-100))
...
class Transition_screen():
    ...
    def update(self,spaceship):
        ...
        if mtos_dis < World_pos.offset_distance +15:
            ...
            if pygame.Rect.colliderect(spaceship.rect,desert_planet.rect):
                Transition_screen.change_state(self,"Desert_planet",(191,123,32))
            if pygame.Rect.colliderect(spaceship.rect,moss_planet.rect):
...
while True:
    ...
    if Game_State != "Death_screen":
        ...
        text = font.render("Health Depleted", True, (255, 255, 255))  # White color text
        text_rect = text.get_rect(center=(SCREEN_WIDTH/2, SCREEN_HEIGHT/2))
        text2 = font.render("Press space to return to spaceship", True, (255, 255, 255))  # White color text
        text_rect2 = text.get_rect(center=(SCREEN_WIDTH/2-140, SCREEN_HEIGHT/2+40))
        screen.blit(text,text_rect)
        screen.blit(text2,text_rect2)
        ...
        for event in pygame.event.get():
            ...
            if Game_State == "Death_screen":
                ...
                if pygame.key.get_pressed()[pygame.K_SPACE]:
                    ...
                    spaceship.rect.y = SCREEN_HEIGHT/2
                    space_station.rect.x  = SCREEN_WIDTH/2
                    space_station.rect.y =  SCREEN_HEIGHT/2
                    transition_screen.transparecy = 255
